    ...
    <div className="animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
            ...
            {items.map((item, index) => {
              ...
              return (
                <div
                  key={item.id}
                  className={cn(
                    "grid grid-cols-1 md:grid-cols-12 gap-3 p-3 rounded-lg border border-gray-100 bg-gray-50/50",
                    "animate-fade-in"
                  )}
                >
                  {/* Description */}
                  <div className="md:col-span-5">
                    ...
                    <input
                      ...
                      placeholder={`Ligne ${index + 1} — Description du service...`}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-end gap-3 pb-8">
          <Link href="/invoices" className="btn-ghost w-full sm:w-auto">
            Annuler
          </Link>
          <button
